...
server <- function(input, output, session) {
  ...
  shiny::observeEvent(input$CatBoostCARMA_Modal, {
    Quantico:::CatBoostCARMA_Modal_Fun(
      ...
      # Updaters
      CatBoostCARMA_ModelID_Selected = if(length(input$CatBoostCARMA_ModelID) > 0L) input$CatBoostCARMA_ModelID else 'FC001',
  ...
  shiny::observeEvent(input$XGBoostCARMA_Modal, {
    Quantico:::XGBoostCARMA_Modal_Fun(
      ...
      XGBoostCARMA_CalendarVariables_Choices = list("Minute of Hour" = "minute","Hour of Day" = "hour","Day of Week" = "wday", "Day of Month" = "mday","Day of Year" = "yday","Week of Year" = "week", "Isoweek of Year" = "isoweek", "Week of Month" = "wom", "Month of Year" = "month", "Quarter of Year" = "quarter"),
  ...
  shiny::observeEvent(input$LightGBMCARMA_Modal, {
    Quantico:::LightGBMCARMA_Modal_Fun(
      ...
      LightGBMCARMA_CalendarVariables_Choices = list("Minute of Hour" = "minute","Hour of Day" = "hour","Day of Week" = "wday", "Day of Month" = "mday","Day of Year" = "yday","Week of Year" = "week", "Isoweek of Year" = "isoweek", "Week of Month" = "wom", "Month of Year" = "month", "Quarter of Year" = "quarter"),
  ...
  shiny::observeEvent({eval(FCReportOutputExpression)}, {
    if(Debug) print("FC Markdown 1")
    Page <- tryCatch({as.integer(gsub("[^\\d]+", "", input$tabss, perl=TRUE))}, error = function(x) 0L)
    if(length(ModelOutputList) > 0L) {
      shiny::withProgress(message = 'FC Report Exporting Has Begun..', value = 0, {
