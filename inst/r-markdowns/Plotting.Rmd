...
#  <font size="5">DataMuse Plotting Output</font>

```{r PlotOutputList, echo=FALSE}

# Update height and width to conform to markdown page size
for(i in seq_along(PlotOutputList)) {
  PlotOutputList[[paste0("Plot", i)]]$width <- "975px"
  PlotOutputList[[paste0("Plot", i)]]$height <- "600px"
}

# display
echarts4r::e_arrange(PlotOutputList)
```
